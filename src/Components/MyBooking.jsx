    ...
    <div className="findDoctor-container">
      ...
      <div className="booking-navbar">
        ...
        <div className="nav-btn-container">
          ...
          <button className="nav-btn-1">My Booking</button>
        </div>
      </div>
      <div className="searchBar-booking">
        <p className="searchBar-text-1">My Bookings</p>
        <div className="search-inputBox-booking-1">
            <div className="input-container-1">
              <input type="text" className="input-box" placeholder="Search By Hospital"/>
            </div>
         ...
         {allBookings.map((item) =>{
          return (
            ...
            <div className="hospital-container-middle">
                 <p className="hospital-container-text-1">{item["Hospital Name"]}</p>
                 <div className="hospital-container-middle-text">
                  <p className="hospital-container-text-2">{item.City}, {item.State}</p>
            ...
            <div className="hospital-container-right-1">
                 <div className="hospital-container-right-booking-1">{item.bookingTime}</div>
                 <button className="hospital-container-right-booking-2">{item.bookingDate}</button>
            </div>
          </div>
          )
        })}
      ...
      <div className="download-container">
        ...
        <div className="download-container-right">
          ...
          <div className="download-container-options">
            <p className="download-option-text-1">Download the <span className="download-span-1">Medify</span> App</p>
            <p className="download-option-text-2">Get the link to download the app</p>
            <div  className="number-inputWrap">
              <div className="number-input-1">+91</div>
              <input type="number" placeholder="Enter phone number" className="mobile-number-inputBox"/>
